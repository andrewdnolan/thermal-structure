! ******************************************************************************
! *
! *  Authors: Fabien Gillet-Chaulet, Andrew Nolan
! *  Github:  fgillet, andrewdnolan
! *
! *  Date Written:
! *   2022/06/02
! *
! *  Note:
! *   The majority of this script is taken directly from the "ElmerIce_ISMIP6Utils"
! *   repo by fgillet. I've made some minimal additions for working in 2D (x-z)
! *   structured meshes and some other minor tweaks around the edges.
! ******************************************************************************
