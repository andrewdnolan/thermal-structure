...
def main(argv):
    ...
    parser.add_argument('-cycle2',f'--{vars["cycle2"]["flag_var"]}', action="store_true",
                        help = "Whether the second cycle in the surge until steady state")
    ...
    cmd   = "source surge2steady.sh; surge2steady"
