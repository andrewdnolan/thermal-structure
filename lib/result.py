...
class result_file:
    ...
    def __parse_mesh_params(self, simul_type="Steady"):
        ...
        elif mesh_params["Simulation Type"] == "transient":
            mesh_params["NT"] = nt
        else:
            raise NotImplemented("Simulation type must be \"steady\" or \"transient\" ")
    ...
    def __read_result(self):
        ...
        if self.mesh_params["Simulation Type"] == "steady":
            nt = self.mesh_params["S.S. itters"]
        elif self.mesh_params["Simulation Type"] == "transient":
            nt = self.mesh_params["NT"]
    ...
    def __init__(self, result_fp, nodes_fp, simul_type="Steady"):
        ...
        self.__parse_mesh_params(simul_type="Transient")
